    ...
    function confirmDelete(uuid) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.action = '/categories/'+ uuid + '/destroy';
